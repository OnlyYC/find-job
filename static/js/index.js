...
var initMap = function(){
	...
	map.centerAndZoom(new BMap.Point(106.509785, 29.522053), 13);  // 初始化地图,设置中心点坐标和地图级别
...
var addMarker = function(){
    ...
    var point = new BMap.Point(106.509785, 29.522053);
...
// 创建地址解析器实例
	...
	myGeo.getPoint(addr, function(point){
		if (point) {
            ...
            <p>来源：<a href='${compURL}' target="_blank">${source}</a></p>
            `
